...
class WallWed extends StatefulWidget {
  @override
  _WallWedState createState() => _WallWedState();
}

class _WallWedState extends State<WallWed> {
  ...
  uploadImageToFirebase() async
  {
    ...
    if(permissionStatus.isGranted)
    {
      ...
      {
        //Upload to Firebase
        var snapshot = await _storage.ref().child('Wallpaper/$imageFileName').putFile(file);
         ...
         child: Column(
          //  mainAxisAlignment: MainAxisAlignment.center,
           ...
           children: <Widget>[
            ...
            Container(
              child: Text("Wallpaper Wednesday", style: GoogleFonts.montserrat(
                  fontSize: 27.0,
